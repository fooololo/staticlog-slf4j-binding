...
import de.jupf.staticlog.SLF4JBindingFacade;
...
public class StaticLogger implements Logger {
    ...
    private final de.jupf.staticlog.core.Logger logger;
    ...
    public boolean isDebugEnabled() {
        return logger.getLogLevel().ordinal() <= LogLevel.DEBUG.ordinal();
    }
    ...
    public boolean isInfoEnabled() {
        return logger.getLogLevel().ordinal() <= LogLevel.INFO.ordinal();
    }
    ...
    public boolean isWarnEnabled() {
        return logger.getLogLevel().ordinal() <= LogLevel.WARN.ordinal();
    }
    ...
    public boolean isErrorEnabled() {
        return logger.getLogLevel().ordinal() <= LogLevel.ERROR.ordinal();
    }
